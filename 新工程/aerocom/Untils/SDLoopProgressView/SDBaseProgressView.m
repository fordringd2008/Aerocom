...
- (void)setCenterProgressText:(NSString *)text withAttributes:(NSDictionary *)attributes
{
    ...
    if ([[UIDevice currentDevice].systemVersion floatValue] >= 7.0) {
        ...
        if (attributes[NSFontAttributeName]) {
            ...
            strSize = CGSizeMake(320,2000); //设置一个行高上限
            NSDictionary * tdic = [NSDictionary dictionaryWithObjectsAndKeys:attributes[NSFontAttributeName], NSFontAttributeName,nil];
            strSize =[text boundingRectWithSize:strSize options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
            ...
            strSize = CGSizeMake(320,2000); //设置一个行高上限
            NSDictionary * tdic = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:[UIFont systemFontSize]], NSFontAttributeName,nil];
            strSize =[text boundingRectWithSize:strSize options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
