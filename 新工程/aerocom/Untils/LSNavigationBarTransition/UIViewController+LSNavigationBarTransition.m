...
- (void)ls_viewDidLoad
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[[UIColor colorWithRed:28.0/255.0 green:184.0/255 blue:39.0/255.0 alpha:1.000] imageWithColor] forBarMetrics:UIBarMetricsDefault];
}
...
//    [self DF_ls_addNavigationBarIfNeed];
}

-(void)DF_ls_addNavigationBarIfNeed
{
    UIView* backgroundView = [self.navigationController.navigationBar valueForKey:@"_backgroundView"];
    CGRect rect = [backgroundView.superview convertRect:backgroundView.frame toView:self.view];
    UINavigationBar* bar = [[UINavigationBar alloc] initWithFrame:rect];
